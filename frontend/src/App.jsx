...
const TESTIMONIALS = [
  {
    quote:
      "TaskForge replaced four tools. Our engineering org of 200 now ships without a program manager overhead.",
    name: "Sadie Okonkwo",
  ...
  {
    quote:
      "The dependency graph alone saved our Q3 launch. We caught the blocker three weeks before the deadline.",
    name: "Tomás Rueda",
  ...
  {
    quote:
      "We tried Linear, Jira, Monday. Nothing handles cross-team work like TaskForge.",
    name: "Priya Nath",
...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {/* Hero */}
      <section
        className="relative overflow-hidden px-8 pt-24 pb-20"
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-end">
          <div>
            ...
            <p
              ...
              style={{ color: "#a0a09a", lineHeight: 1.6 }}
            >
              TaskForge is the project management platform built for engineering
              teams that move fast and can&apos;t afford ambiguity.
            </p>
            <div className="flex flex-wrap items-center gap-4">
              ...
              <button
                ...
                style={{ border: "1px solid #222220", color: "#a0a09a" }}
                onMouseEnter={(e) =>
                  (e.currentTarget.style.borderColor = "#6b6b65")
                }
                onMouseLeave={(e) =>
            ...
            >
              ...
              <div className="px-4 pt-4 pb-2">
                ...
                >
                  <div
                    ...
                    style={{ width: "62%", backgroundColor: "#d4ff00" }}
                  />
                </div>
              ...
              <div className="px-4 pb-4 space-y-1 mt-2">
                {[
                  ...
                  {
                    title: "Redesign onboarding flow step 2",
                    assignee: "MR",
                    status: "In Progress",
                    priority: "P1",
                  },
                  ...
                  {
                    title: "Add audit log export endpoint",
                    assignee: "TN",
                    status: "Review",
                    priority: "P2",
                  },
                  {
                    title: "Fix Stripe webhook retry loop",
                    assignee: "KL",
                    status: "Blocked",
                    priority: "P0",
                  },
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: i === 4 ? "#1a0a0a" : "transparent",
                      border:
                        i === 4 ? "1px solid #3a1a1a" : "1px solid transparent",
                    }}
                  >
                    <div
                    ...
                    <span
                      ...
                      style={{
                        color: task.status === "Done" ? "#6b6b65" : "#f0efe8",
                      }}
                    >
                      {task.title}
                    </span>
      ...
      >
        <div
          className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-0 divide-x"
          style={{ borderColor: "#222220" }}
        >
          {[
            ...
            >
              <div
                className="font-display font-800 text-4xl mb-1"
            ...
            {FEATURES.map((f) => (
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <span
                    className="font-display font-600 text-xs"
                    style={{ color: "#3a3a38" }}
                  >
                    {f.number}
                  </span>
                  <div className="text-right">
                    <div
                      ...
                      style={{ color: "#d4ff00", letterSpacing: "-0.02em" }}
                    >
                      {f.stat}
                    </div>
                ...
                <h3 className="font-display font-700 text-xl mb-3 uppercase tracking-wide">
                  {f.title}
                </h3>
                <p
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            >
              ...
              not how a vendor thinks you should. Transitions are auditable,
              reversible, and automatable.
            </p>
            <div className="space-y-2">
              {WORKFLOW_STEPS.map((step) => (
                <button
                  ...
                  style={{
                    border: `1px solid ${
                      activeStep === step.id ? step.color : "#222220"
                    }`,
                    backgroundColor:
                      activeStep === step.id
                        ? "rgba(212,255,0,0.04)"
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span
                      ...
                      style={{
                        color: activeStep === step.id ? step.color : "#f0efe8",
                      }}
                    >
                      {step.label}
                    </span>
                ...
                <div key={step.id}>
                  <div className="mb-2 flex items-center justify-between">
                    <span
                      ...
                      style={{
                        color: activeStep === step.id ? step.color : "#6b6b65",
                      }}
                    >
                      {step.label}
                    </span>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <p
            className="text-xs uppercase tracking-widest mb-16 font-display text-center"
            style={{ color: "#6b6b65" }}
          >
          ...
          <div className="text-center mb-12">
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    color: billingAnnual ? "#0a0a0a" : "#d4ff00",
                    fontSize: "0.7em",
                  }}
                >
                  -20%
          ...
          >
            {PLANS.map((plan) => (
              ...
              >
                ...
                <div className="mb-6">
                  <div
                    className="font-display font-700 text-sm uppercase tracking-widest mb-4"
                    style={{ color: "#6b6b65" }}
                  >
                    {plan.name}
                  </div>
      ...
      <section className="px-8 py-32">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p
            className="text-lg mb-10 mx-auto max-w-md"
            style={{ color: "#a0a09a" }}
          >
      ...
      <footer className="px-8 py-10" style={{ borderTop: "1px solid #222220" }}>
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div
            ...
            style={{ color: "#6b6b65" }}
          >
            {["Privacy", "Terms", "Security", "Status", "Changelog"].map(
              (l) => (
                <a
                  key={l}
                  href="#"
